...
export const EditWebsiteDialog = ({
  website,
  onWebsiteUpdated,
  open,
  onOpenChange,
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    toast.loading('Updating your website...');
    ...
    try {
      ...
      toast.dismiss();
      toast.success(
        'Website updated! It will be reviewed again before appearing on the site.'
      );
      onWebsiteUpdated();
      onOpenChange(false);
    } catch (err) {
      toast.dismiss();
      toast.error('There was an error updating your website.');
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-h-[90vh] overflow-y-auto max-w-150">
        <DialogHeader>
          ...
          <DialogDescription>
            Your submission will be re-reviewed by an administrator
        ...
        <form onSubmit={handleSubmit} className="space-y-4 mt-4">
          ...
          <div className="space-y-1">
            <Label htmlFor="photo">New Screenshot (optional)</Label>
            <Input
              id="photo"
              type="file"
